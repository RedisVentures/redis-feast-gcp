...
def get_feature_store(config_path: str, bucket_name: str) -> FeatureStore:
    """
    ...
    """
    return FeatureStore(
        config=fetch_pkl(remote_filename=config_path, bucket_name=bucket_name)
    )


def get_blob(remote_filename: str, bucket_name: str):
    """
...
def upload_file(local_filename: str, bucket_name: str, remote_filename: str) -> None:
    """
...
def fetch_pkl(bucket_name: str, remote_filename: str) -> Any:
    """
...
def download_file_url(filename: str, url: str):
    """
